...
namespace CadastroProdutos.Migrations
{
    ...
    [Migration("20220715181125_teste")]
    partial class teste
    {
            ...
            modelBuilder.Entity("CadastroProdutos.Models.Produto", b =>
                {
                    ...
                    b.Property<int>("DefSituacaoProdutoSituacaoProdutoId")
                        .HasColumnType("int");

                    b.Property<int>("DefUnidadeComercialUnidadeComercialID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DefSituacaoProdutoSituacaoProdutoId");

                    b.HasIndex("DefUnidadeComercialUnidadeComercialID");
            ...
            modelBuilder.Entity("CadastroProdutos.Models.Produto", b =>
                {
                    b.HasOne("CadastroProdutos.Models.DefSituacaoProduto", "DefSituacaoProduto")
                        .WithMany("Produtos")
                        .HasForeignKey("DefSituacaoProdutoSituacaoProdutoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CadastroProdutos.Models.DefUnidadeComercial", "DefUnidadeComercial")
                        .WithMany("Produtos")
                        .HasForeignKey("DefUnidadeComercialUnidadeComercialID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
